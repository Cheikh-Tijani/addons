...
var DashboardApps = Widget.extend({
    ...
    confirm_upgrade: function() {
        framework.redirect("https://www.groupesepro.com/seproerp-enterprise/upgrade?num_users=" + (this.data.enterprise_users || 1));
    },
});
...
var DashboardShare = Widget.extend({
    ...
    init: function(parent, data){
        this.data = data;
        this.parent = parent;
        this.share_url = 'https://www.groupesepro.com';
        this.share_text = encodeURIComponent("I am using #SeproERP - Awesome open source business apps.");
    },
    ...
    share_linkedin: function(){
        var popup_url = _.str.sprintf('http://www.linkedin.com/shareArticle?mini=true&url=%s&title=I am using seproerp&summary=%s&source=www.groupesepro.com', encodeURIComponent(this.share_url), this.share_text);
        this.sharer(popup_url);
    },
